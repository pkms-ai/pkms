...
from db_service.db import DatabaseConfig, get_db_pool
from db_service.initialize_db import (
...
async def test_check_url_exists(db_pool):
    ...
    assert exists is True  # This URL should exist from populate_database
